...
vim.api.nvim_create_user_command('RemoveZoneIdentifiers', function()
  -- Execute the shell command to find and remove Zone.Identifier files
  os.execute "find . -type f -name 'Zone.Identifier' -exec rm -f {} +"
end, {})
